...
![&#x6DFB;&#x52A0;require&#x4EE3;&#x7801;&#x63D0;&#x793A;1](.gitbook/assets/image%20%282%29.png)

![&#x6DFB;&#x52A0;require&#x4EE3;&#x7801;&#x63D0;&#x793A;2](.gitbook/assets/image%20%281%29.png)

![WebStorm &#x6253;&#x5F00;Node.js&#x7684;&#x4EE3;&#x7801;&#x63D0;&#x793A;&#x529F;&#x80FD;](.gitbook/assets/image%20%2810%29.png)
...
把上方代码32行注释打开即可看到效果,注意var moment = require\('moment'\);
...
而 npm init 给我们提供了项目初始化的功能，也解决了多个包的管理问题：\(会生成package.age\)文件
...
![](.gitbook/assets/snipaste_2018-09-26_14-44-19.png)

package.json的作用就是用来记录当前项目及包的使用情况；`不能在package.json中添加注释`

package-lock.json 保存第三方包的版本和下载路径等详细信息；当我们使用npm管理包时，package.json 及package-lock.json 的内容都会自动更新
